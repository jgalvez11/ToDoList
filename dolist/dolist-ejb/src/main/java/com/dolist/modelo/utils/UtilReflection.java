package com.dolist.modelo.utils;

import com.dolist.modelo.excepciones.ReflectionException;
import static com.dolist.modelo.utils.UtilConstantes.INT_PRIMITIVE;
import static com.dolist.modelo.utils.UtilConstantes.LONG_PRIMITIVE;
...
public class UtilReflection {
	 ...
	 * @param nombreAtributo Nombre del atributo del cual se quiere consultar el
	 *                       get.
	...
	/**
	 * Devuelve el atributo etiquetado con @EmbbededId de la clase que define una
	...
	/**
	 * Devuelve el nombre del atributo etiquetado con @Id de la entidad que se pasa
	 * como parámetro.
	 * 
