...
import static com.dolist.modelo.utils.UtilReflection.consultarAtributoId;
import static com.dolist.modelo.utils.UtilReflection.consultarAtributoPKCompleja;
import static com.dolist.modelo.utils.UtilReflection.consultarAtributosClase;
import static com.dolist.modelo.utils.UtilReflection.consultarMetodoGetAtributo;
import static com.dolist.modelo.utils.UtilReflection.esPkCompleja;
...
public class ManejadorPersistencia<T> implements Serializable {
	 ...
	 * @param idObj        Puede ser una instancia de una pk compuesto de una
	 *                     entidad o un id simple (Ej. Integer, String, Long, etc)
	 */
